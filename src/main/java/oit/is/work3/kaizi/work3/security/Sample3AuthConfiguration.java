package oit.is.work3.kaizi.work3.security;
...
public class Sample3AuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails user1 = User.withUsername("user1")
        .password("{bcrypt}$2y$05$2Qap.5lJLL7g.qCVN4gUJOmCKLByUHy0dZIDBLNF7xcAltRgbCdZe").roles("USER").build();
    UserDetails user2 = User.withUsername("user2")
        .password("{bcrypt}$2y$05$dCwgNte5zMDguNcdTS60L.vz6lVEtpPWeNlzClaiFcI3Ba2TrY9WW").roles("USER").build();
